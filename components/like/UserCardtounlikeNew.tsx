...
const UserCardunlikeNew = ({
  ...
  return (
    <article className="group relative  rounded-md overflow-hidden shadow-md flex flex-col bg-secondary">
      ...
      <div className="flex-[.1] bg-gradient-to-r from-indigo-500 to-purple-500  absolute bottom-16 left-0 opacity-0 group-hover:opacity-100 group-hover:bottom-17 h-12 group-hover:h-[180px] w-full transition-all duration-500 ease-out rounded p-2 flex flex-col gap-2">
...
export default UserCardunlikeNew
