    ...
    <div className="font-sans transition-colors duration-200 dark:bg-gray-900">
      ...
      <div className="sticky top-0 gap-4 z-50 w-full bg-white dark:bg-gray-900 shadow-md">
        <div className="container mx-auto px-4 py-2 flex justify-end">
          <Button className="bg-gray-200 dark:bg-gray-800 text-fuchsia-600 dark:text-fuchsia-400 font-bold py-3 px-8 rounded-full hover:bg-fuchsia-100 dark:hover:bg-gray-700 transition duration-300">
            Start Your Journey
          </Button>{' '}
          <ThemeSwitch />
        </div>
      ...
      <header className="h-screen flex items-center justify-center bg-gradient-to-r from-indigo-400 via-fuchsia-500 to-pink-500 dark:from-indigo-700 dark:via-fuchsia-800 dark:to-pink-800">
        <div className="text-center">
          ...
          <button className="bg-white dark:bg-gray-800 text-fuchsia-600 dark:text-fuchsia-400 font-bold py-3 px-8 rounded-full hover:bg-fuchsia-100 dark:hover:bg-gray-700 transition duration-300">
            Start Your Journey
          </button>
        </div>
      </header>
      ...
      <section className="relative h-96 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center">
          ...
          <button className="bg-gradient-to-r from-fuchsia-500 to-rose-500 text-white font-bold py-3 px-8 rounded-full hover:from-fuchsia-600 hover:to-rose-600 transition duration-300">
            Join Now
          </button>
        </div>
      </section>
