...
export default function ComponentSUBSCRIPTION() {
  ...
  console.log('Yearly Plan Link:', process.env.STRIPE_YEARLY_PLAN_LINK!)
  console.log('Monthly Plan Link:', process.env.STRIPE_MONTHLY_PLAN_LINK!)
              ...
              <Button
                ...
                /*  href={
                  typeof tier.href === 'string'
                    ? tier.href
                    : tier.href[selectedFrequency.key]
                } */
                href={
                  typeof tier.href === 'string'
                    ? tier.href
                    : (console.log(
                        'Selected Frequency Key i:',
