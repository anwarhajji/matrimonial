import { getDataUser, getLikedUsers, getUsersILike } from '@/actions/userdata'
...
const HOME = async () => {
  ...
  const listusers = await getLikedUsers(session?.user?.id!)
  ...
  return (
    <>
      <div className="flex justify-center mb-4">
        <h1 className="text-xl font-bold bg-white rounded-full py-2 px-4">
          Users I Liked
        </h1>
      </div>
      {listusers.length === 0 && (
